...
<li>
    <a class="flex items-center no-underline text-grey-darker group hover:text-blue ml-10" href="{{ route('donate.request') }}">
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="fill-current w-6 h-6 mr-2 group-hover:text-primary">
...
<li>
    <a class="flex items-center no-underline text-grey-darker group hover:text-blue ml-10 {{ active_nav('donate.history') }}" href="{{ route('donate.history') }}">
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="fill-current w-6 h-6 mr-2 group-hover:text-primary">
